...
const MasterDataWorkspaceSkeleton = () => {
  return (
    <div className="w-full">
      <div className="overflow-x-auto">
        ...
        <div className="flex animate-pulse flex-col gap-4 border-t border-slate-200 px-5 py-4 dark:border-slate-800 sm:flex-row sm:items-center sm:justify-between">
...
export default MasterDataWorkspaceSkeleton;
