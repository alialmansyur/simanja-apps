...
const HistoryWorkspaceSkeleton = () => {
  return (
                ...
                <tr key={rowIndex} className="border-t border-slate-200 dark:border-slate-800">
                  {Array.from({ length: 5 }).map((__, cellIndex) => (
                    <td key={cellIndex} className="px-5 py-4">
                      <div className="h-4 w-full max-w-[12rem] rounded-full bg-slate-200 animate-pulse dark:bg-slate-800" />
                      {cellIndex === 0 ? (
                        <div className="mt-2 h-3 w-32 rounded-full bg-slate-100 animate-pulse dark:bg-slate-800/70" />
                      ) : cellIndex === 1 ? (
                        <div className="mt-2 h-3 w-20 rounded-full bg-slate-100 animate-pulse dark:bg-slate-800/70" />
                      ) : null}
                    </td>
                  ))}
                </tr>
...
export default HistoryWorkspaceSkeleton;
