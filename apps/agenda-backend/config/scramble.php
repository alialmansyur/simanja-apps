...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Dokumentasi Resmi RESTful API SIMANJA (Sistem Informasi Manajemen Agenda Kanreg III BKN).',
    ],

    'ui' => [
        'title' => 'SIMANJA API Documentation',
    ],
    ...
    'middleware' => [
        'web',
        \App\Http\Middleware\AuthorizeDocsAccess::class,
    ],
